...
let lastOrderMessage = "";
  ...
  // Add event listener for the "Share Live Location" button
document.getElementById("getLocation").addEventListener("click", () => {
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
      ...
      document.getElementById("locationField").value = locationLink;

      // Show clickable link
      document.getElementById("locationField").style.cursor = "pointer";
...
const liveLocation = document.getElementById("locationField").value;
if (liveLocation) {
  summary += `Live Location: ${liveLocation}\n\n`;
}
  ...
  body: JSON.stringify({
    ...
    Contact: contact,
    Address: location,
    Location: document.getElementById("locationField").value, // ✅ new field
